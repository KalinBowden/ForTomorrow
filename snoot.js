...
function validateAddress(fieldsetId)
{
  ...
  try
  {
    ...
    if (fieldsetValidity === false)
    {
      ...
      {
        throw "please cpmplete all delivery address info";
      }
    }
    else
    {
...
function validateDeliveryDate()
{
  ...
  try
  {
    ...
    if (fieldsetValidity === false)
    {
      throw "Please specify a del date";
    }
    else
    {
      errorDiv.style.display = "none";
...
function validatePayment()
{
  ...
  try
  {
    ...
    {
      ccNumElement.style.background = "rgb(255,223,233)";
      fieldsetValidity = false;
    }
    else
    {
    ...
    if (!fieldsetValidity)
    {
      throw "please cpmplete all payment information";
    }
    else
    {
      errorDiv.style.display = "none";
...
function validateMessage()
{
  ...
  try
  {
    ...
    {
      throw "please enter your msg text";
    }
    else
    {
      errorDiv.style.display = "none";
...
function validateNumbers()
{
  ...
  catch (msg)
  {
    if (ccNotNum)
    {
      ...
      ccNumErrMsg.innerHTML = "the cc num " + msg;
    }
    ...
    if (cvvotNum)
    {
      ...
      cvvErrMsg.innerHTML = "the cvv " + msg;
    }
...
function createEventListeners(){
  ...
  var form = document.getElementsByTagName("fprm")[0];
